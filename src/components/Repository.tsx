  ...
  return (
    <div className={`repository`}>
      <div className="flex flex-row items-center col-span-1 row-span-1">
        ...
        <IoIosArrowDropdown className="cursor-pointer" onClick={() => toggleMoreInfos(!moreInfosActive)} />
      </div>
      ...
      <div className={`moreInfos ${moreInfosActive ? "active" : ""}`}>
        <div className="moreHeader">
          <span className="bg-slate-200 p-1 rounded-md m-1">Owner: {repo.owner.login}</span>
          <span className="text-lg">Description: {repo.description?repo.description:'No description'}</span>
